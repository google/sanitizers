...
void InstrumentMops(void *drcontext, instrlist_t *bb, instr_t *i, opnd_t op,
                    bool is_write) {
...
void InstrumentReturn(void *drcontext, instrlist_t *bb, instr_t *i) {
  dr_save_reg(drcontext, bb, i, DR_REG_XAX, SPILL_SLOT_1);
...
void InstrumentIndirectBranch(void *drcontext, instrlist_t *bb, instr_t *i) {
  dr_save_reg(drcontext, bb, i, DR_REG_XAX, SPILL_SLOT_1);
  ...
  PRE(i, mov_st(drcontext, OPND_CREATE_MEM64(DR_REG_XAX, msan_param_tls_offset),
                OPND_CREATE_INT32(0)));
  PRE(i, mov_st(drcontext, OPND_CREATE_MEM64(DR_REG_XAX, msan_param_tls_offset +
                                             8), OPND_CREATE_INT32(0)));
  PRE(i, mov_st(drcontext, OPND_CREATE_MEM64(DR_REG_XAX, msan_param_tls_offset +
                                             16), OPND_CREATE_INT32(0)));
  PRE(i, mov_st(drcontext, OPND_CREATE_MEM64(DR_REG_XAX, msan_param_tls_offset +
                                             24), OPND_CREATE_INT32(0)));
  PRE(i, mov_st(drcontext, OPND_CREATE_MEM64(DR_REG_XAX, msan_param_tls_offset +
                                             32), OPND_CREATE_INT32(0)));
  PRE(i, mov_st(drcontext, OPND_CREATE_MEM64(DR_REG_XAX, msan_param_tls_offset +
                                             40), OPND_CREATE_INT32(0)));
...
bool drsys_iter_memarg_cb(drsys_arg_t *arg, void *user_data) {
  ...
  if (sz > 0xFFFFFFFF) {
    ...
    dr_printf("SANITY: syscall '%s' arg %d writes %llu bytes memory?!"
              " Clipping to %llu.\n", name, arg->ordinal,
              (unsigned long long) sz, (unsigned long long)(sz & 0xFFFFFFFF));
  }
