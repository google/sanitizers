...
C:\cygwin\bin\make -s PLATFORM=Windows CC=../llvm-build/bin/clang-cl FILECHECK=../llvm-build/bin/FileCheck CFLAGS="-fsanitize=address" UAR_FLAG="-fsanitize=use-after-return" -k || goto :DIE
